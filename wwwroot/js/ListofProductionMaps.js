                        ...
                        render: function (data, type, row) {
                            ...
                            return `
                                    <div class="btn-group w-100" role="group">
                                        ...
                                        <button class="btn btn-primary" onclick="EditProdMapModal('${row.productionMapId}', '${nameEscaped}', '${plantEscaped}', '${imgEscaped}','${row.plantNo}')">
...
function EditProdMapModal(productionMapId, productionMapName, plantName, imgName, plantNo) {
    $('#ProdMapModal').modal('show');
